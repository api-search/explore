...
- name: Stripe Application Secrets API
  ...
  - type: OpenAPI
    url: application-secrets-openapi   
...
- name: Stripe Financial Connections API
  ...
  - type: OpenAPI
    url: financial-connections-openapi      
