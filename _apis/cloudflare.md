      ...
      - type: API Evangelist Ratings
        data:
          ...
          rules:
            ...
            - code: openapi-request-body-have-schema-error
              message: Request Body Schema
            ...
            - code: openapi-response-get-200-content-error
              message: GET Content
            - code: openapi-parameters-schema-allof-info
            ...
            - code: openapi-response-get-default-media-type-schema-error
              message: Schema Default
            ...
            - code: openapi-response-get-404-status-code-info
              message: 404 Status Code for GET Responses
            - code: openapi-parameters-schema-oneof-info
