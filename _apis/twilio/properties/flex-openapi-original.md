    ...
    CreateWebChannelRequest:
      ...
      properties:
        AddressSid:
          type: string
          description: >-
            The SID of the Conversations Address. See [Address Configuration
        ...
        CustomerFriendlyName:
          type: string
          description: >-
            The Conversation participant's friendly name. See the [Conversation
            Participant
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateWebChannelRequest'
servers:
  - url: 'https://flex-api.twilio.com'
tags:
