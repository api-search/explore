...
components:
  schemas:
    ...
    UpdateDeployedDevicesCertificateRequest:
      ...
      properties:
        FriendlyName:
          type: string
          description: >-
            Provides a human readable descriptive text for this Certificate
            credential, up to 256 characters long.
        DeviceSid:
          type: string
          minLength: 34
          ...
          pattern: '^TH[0-9a-fA-F]{32}$'
          description: >-
            Provides the unique string identifier of an existing Device to
            become authenticated with this Certificate credential.
    CreateDeployedDevicesCertificateRequest:
      ...
      properties:
        CertificateData:
          type: string
          description: >-
            Provides a URL encoded representation of the public certificate in
            PEM format.
        FriendlyName:
          type: string
          description: >-
      ...
      properties:
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    UpdateDeployedDevicesDeploymentRequest:
      type: object
      properties:
        FriendlyName:
          type: string
          description: >-
            Provides a human readable descriptive text for this Deployment, up
            to 64 characters long
        SyncServiceSid:
          type: string
          minLength: 34
          ...
          pattern: '^IS[0-9a-fA-F]{32}$'
          description: >-
            Provides the unique string identifier of the Twilio Sync service
            instance that will be linked to and accessible by this Deployment.
    CreateDeployedDevicesDeploymentRequest:
      type: object
      properties:
        FriendlyName:
          type: string
      ...
      properties:
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    UpdateDeployedDevicesDeviceRequest:
      type: object
      properties:
        FriendlyName:
          type: string
          description: >-
            Provides a human readable descriptive text to be assigned to this
            Device, up to 256 characters long.
        Identity:
          type: string
          description: >-
            Provides an arbitrary string identifier representing a human user to
            be associated with this Device, up to 256 characters long.
        DeploymentSid:
          type: string
          minLength: 34
          maxLength: 34
          ...
          description: >-
            Specifies the unique string identifier of the Deployment group that
            this Device is going to be associated with.
        Enabled:
          type: boolean
          description: ''
    CreateDeployedDevicesDeviceRequest:
      type: object
      properties:
        UniqueName:
          type: string
          description: >-
            Provides a unique and addressable name to be assigned to this
            Device, to be used in addition to SID, up to 128 characters long.
        FriendlyName:
          type: string
          description: >-
            Provides a human readable descriptive text to be assigned to this
      ...
      properties:
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    UpdateDeployedDevicesFleetRequest:
      type: object
      properties:
        FriendlyName:
          type: string
        ...
        DefaultDeploymentSid:
          ...
          pattern: '^DL[0-9a-fA-F]{32}$'
          description: >-
            Provides a string identifier of a Deployment that is going to be
            used as a default one for this Fleet.
    CreateDeployedDevicesFleetRequest:
      type: object
      properties:
        FriendlyName:
          type: string
      ...
      properties:
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    UpdateDeployedDevicesKeyRequest:
      type: object
      properties:
        FriendlyName:
          type: string
          description: >-
            Provides a human readable descriptive text for this Key credential,
            up to 256 characters long.
        DeviceSid:
          type: string
          minLength: 34
          ...
          description: >-
            Provides the unique string identifier of an existing Device to
            become authenticated with this Key credential.
    CreateDeployedDevicesKeyRequest:
      type: object
      properties:
        FriendlyName:
          type: string
      ...
      properties:
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    UpdateHostedNumbersAuthorizationDocumentRequest:
      type: object
      properties:
        HostedNumberOrderSids:
          ...
          items:
            type: string
          description: >-
            A list of HostedNumberOrder sids that this AuthorizationDocument
      ...
      properties:
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    CreateHostedNumbersAuthorizationDocumentRequest:
      type: object
      required:
        - HostedNumberOrderSids
        - AddressSid
      ...
      properties:
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    UpdateHostedNumbersHostedNumberOrderRequest:
      type: object
      properties:
        FriendlyName:
          type: string
        ...
        Status:
          ...
          $ref: '#/components/schemas/hosted_number_order_enum_status'
          description: >-
            User can only post to `pending-verification` status to transition
            the HostedNumberOrder to initiate a verification call or
            verification of ownership with a copy of a phone bill.
        VerificationCode:
          type: string
          description: >-
            A verification code that is given to the user via a phone call to
            the phone number that is being hosted.
        VerificationType:
          type: string
          $ref: '#/components/schemas/hosted_number_order_enum_verification_type'
          description: >-
            Optional. The method used for verifying ownership of the number to
            be hosted. One of phone-call (default) or phone-bill.
        VerificationDocumentSid:
          ...
          pattern: '^RI[0-9a-fA-F]{32}$'
          description: >-
            Optional. The unique sid identifier of the Identity Document that
            represents the document for verifying ownership of the number to be
            hosted. Required when VerificationType is phone-bill.
        Extension:
          type: string
        ...
        CallDelay:
          type: integer
          description: >-
            The number of seconds, between 0 and 60, to delay before initiating
            the verification call. Defaults to 0.
    ...
    CreateHostedNumbersHostedNumberOrderRequest:
      ...
      properties:
        PhoneNumber:
          ...
          format: phone-number
          description: >-
            The number to host in [+E.164](https://en.wikipedia.org/wiki/E.164)
            format
        SmsCapability:
          type: boolean
          description: >-
            Used to specify that the SMS capability will be hosted on Twilio's
            platform.
        AccountSid:
          type: string
          minLength: 34
          ...
          pattern: '^AC[0-9a-fA-F]{32}$'
          description: >-
            This defaults to the AccountSid of the authorization the user is
            using. This can be provided to specify a subaccount to add the
        ...
        UniqueName:
          type: string
          description: >-
            Optional. Provides a unique and addressable name to be assigned to
            this HostedNumberOrder, assigned by the developer, to be optionally
        ...
        SmsUrl:
          ...
          format: uri
          description: >-
            The URL that Twilio should request when somebody sends an SMS to the
            phone number. This will be copied onto the IncomingPhoneNumber
            resource.
        SmsMethod:
          type: string
          format: http-method
          enum:
            ...
            - DELETE
          description: >-
            The HTTP method that should be used to request the SmsUrl. Must be
            either `GET` or `POST`.  This will be copied onto the
            IncomingPhoneNumber resource.
        SmsFallbackUrl:
          type: string
          format: uri
          description: >-
            A URL that Twilio will request if an error occurs requesting or
            executing the TwiML defined by SmsUrl. This will be copied onto the
            IncomingPhoneNumber resource.
        SmsFallbackMethod:
          type: string
          format: http-method
          ...
          description: >-
            ...
            Must be either `GET` or `POST`. This will be copied onto the
            IncomingPhoneNumber resource.
        StatusCallbackUrl:
          type: string
          format: uri
        ...
        SmsApplicationSid:
          ...
          description: >-
            Optional. The 34 character sid of the application Twilio should use
            to handle SMS messages sent to this number. If a `SmsApplicationSid`
        ...
        AddressSid:
          ...
          description: >-
            ...
            resource that represents the address of the owner of this phone
            number.
        Email:
          type: string
          description: >-
            Optional. Email of the owner of this phone number that is being
            hosted.
        VerificationType:
          type: string
          $ref: '#/components/schemas/hosted_number_order_enum_verification_type'
      ...
      properties:
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    UpdateSyncDocumentPermissionRequest:
      type: object
      required:
        - Read
        - Write
      ...
      properties:
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    UpdateSyncSyncListPermissionRequest:
      type: object
      required:
        - Read
        - Write
      ...
      properties:
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    UpdateSyncSyncMapPermissionRequest:
      type: object
      required:
        - Read
        - Write
    ...
    ListUnderstandAssistantResponse:
      type: object
      properties:
        assistants:
          type: array
        ...
        meta:
          ...
          properties:
            ...
            key:
              type: string
    CreateUnderstandAssistantRequest:
      type: object
      properties:
        FriendlyName:
          type: string
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateDeployedDevicesCertificateRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateDeployedDevicesCertificateRequest'
    get:
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListDeployedDevicesCertificateResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateDeployedDevicesDeploymentRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateDeployedDevicesDeploymentRequest'
    get:
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListDeployedDevicesDeploymentResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateDeployedDevicesDeviceRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateDeployedDevicesDeviceRequest'
    get:
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListDeployedDevicesDeviceResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateDeployedDevicesFleetRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateDeployedDevicesFleetRequest'
    get:
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListDeployedDevicesFleetResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateDeployedDevicesKeyRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateDeployedDevicesKeyRequest'
    get:
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListDeployedDevicesKeyResponse'
          description: OK
      security:
        - accountSid_authToken: []
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: >-
                #/components/schemas/UpdateHostedNumbersAuthorizationDocumentRequest
        ...
        '200':
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/ListHostedNumbersAuthorizationDocumentResponse
          description: OK
      security:
        - accountSid_authToken: []
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: >-
                #/components/schemas/CreateHostedNumbersAuthorizationDocumentRequest
        ...
        '200':
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/ListHostedNumbersDependentHostedNumberOrderResponse
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateHostedNumbersHostedNumberOrderRequest'
        ...
        '200':
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/ListHostedNumbersHostedNumberOrderResponse
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateHostedNumbersHostedNumberOrderRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateSyncDocumentRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateSyncDocumentRequest'
    get:
      description: ''
      tags:
        - PreviewSyncDocument
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListSyncDocumentResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateSyncDocumentPermissionRequest'
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListSyncDocumentPermissionResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateSyncServiceRequest'
  /Sync/Services:
    servers:
      - url: 'https://preview.twilio.com'
    description: 'TODO: Resource-level docs'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateSyncServiceRequest'
    get:
      description: ''
      tags:
        - PreviewSyncService
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListSyncServiceResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateSyncSyncListRequest'
    get:
      description: ''
      tags:
        - PreviewSyncSyncList
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListSyncSyncListResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateSyncSyncListItemRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateSyncSyncListItemRequest'
    get:
      description: ''
      tags:
        - PreviewSyncSyncListItem
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListSyncSyncListItemResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateSyncSyncListPermissionRequest'
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListSyncSyncListPermissionResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateSyncSyncMapRequest'
    get:
      description: ''
      tags:
        - PreviewSyncSyncMap
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListSyncSyncMapResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateSyncSyncMapItemRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateSyncSyncMapItemRequest'
    get:
      description: ''
      tags:
        - PreviewSyncSyncMapItem
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListSyncSyncMapItemResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateSyncSyncMapPermissionRequest'
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListSyncSyncMapPermissionResponse'
          description: OK
      security:
        - accountSid_authToken: []
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListUnderstandAssistantResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateUnderstandAssistantRequest'
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: >-
                #/components/schemas/UpdateUnderstandAssistantFallbackActionsRequest
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: >-
                #/components/schemas/UpdateUnderstandAssistantInitiationActionsRequest
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateUnderstandSampleRequest'
    delete:
      description: ''
      tags:
        - PreviewUnderstandSample
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListUnderstandSampleResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateUnderstandSampleRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateUnderstandStyleSheetRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateUnderstandTaskRequest'
    delete:
      description: ''
      tags:
        - PreviewUnderstandTask
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListUnderstandTaskResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateUnderstandTaskRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateUnderstandTaskActionsRequest'
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListWirelessCommandResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateWirelessCommandRequest'
  /wireless/RatePlans:
    servers:
      - url: 'https://preview.twilio.com'
    description: 'TODO: Resource-level docs'
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListWirelessRatePlanResponse'
          description: OK
      security:
        - accountSid_authToken: []
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/CreateWirelessRatePlanRequest'
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateWirelessRatePlanRequest'
    delete:
      description: ''
      tags:
        - PreviewWirelessRatePlan
    ...
    post:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            schema:
              $ref: '#/components/schemas/UpdateWirelessSimRequest'
  /wireless/Sims:
    servers:
      - url: 'https://preview.twilio.com'
    description: 'TODO: Resource-level docs'
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListWirelessSimResponse'
          description: OK
      security:
        - accountSid_authToken: []
