              ...
              properties:
                ...
                LogQueries:
                  ...
                  description: >-
                    ...
                    Can be: `true` or `false` and defaults to `true`. If `true`,
                    queries are stored for 30 days, and then deleted. If
                    `false`, no queries are stored.
                UniqueName:
                  type: string
                  description: >-
                    An application-defined string that uniquely identifies the
                    resource. It can be used as an alternative to the `sid` in
                    the URL path to address the resource. The first 64
            ...
            schema:
              ...
              properties:
                ...
                UniqueName:
                  ...
                  description: >-
                    An application-defined string that uniquely identifies the
                    new resource. It can be used as an alternative to the `sid`
                    in the URL path to address the resource. The first 64
                    characters must be unique.
                CallbackUrl:
                  type: string
                  format: uri
            ...
            schema:
              ...
              properties:
                ...
                UniqueName:
                  ...
                  description: >-
                    An application-defined string that uniquely identifies the
                    new resource. This value must be a unique string of no more
                    than 64 characters. It can be used as an alternative to the
                    `sid` in the URL path to address the resource.
              required:
                - FieldType
                - UniqueName
            ...
            schema:
              ...
              properties:
                ...
                SynonymOf:
                  type: string
                  description: >-
                    The string value that indicates which word the field value
                    is a synonym of.
              required:
                - Language
                - Value
            ...
            schema:
              ...
              properties:
                UniqueName:
                  ...
                  description: >-
                    An application-defined string that uniquely identifies the
                    resource. This value must be a unique string of no more than
                    64 characters. It can be used as an alternative to the `sid`
            ...
            schema:
              ...
              properties:
                ...
                Tasks:
                  type: string
                  description: >-
                    The list of tasks to limit the new query to. Tasks are
                    expressed as a comma-separated list of task `unique_name`
                    values. For example, `task-unique_name-1,
                    task-unique_name-2`. Listing specific tasks is useful to
            ...
            schema:
              ...
              properties:
                Assistant:
                  type: string
                  description: >-
                    The Twilio-provided string that uniquely identifies the
                    Assistant resource to restore.
              required:
                - Assistant
              ...
              properties:
                ...
                TaggedText:
                  ...
                  description: >-
                    ...
                    The sample can contain [Field tag
                    blocks](https://www.twilio.com/docs/autopilot/api/task-sample#field-tagging).
                SourceChannel:
                  type: string
                  description: >-
                    The communication channel from which the sample was
                    captured. Can be: `voice`, `sms`, `chat`, `alexa`,
            ...
            schema:
              ...
              properties:
                ...
                SourceChannel:
                  type: string
                  description: >-
                    The communication channel from which the new sample was
                    captured. Can be: `voice`, `sms`, `chat`, `alexa`,
                    `google-assistant`, `slack`, or null if not included.
              required:
                - Language
            ...
            schema:
              ...
              properties:
                ...
                UniqueName:
                  ...
                  description: >-
                    An application-defined string that uniquely identifies the
                    resource. This value must be 64 characters or less in length
                    and be unique. It can be used as an alternative to the `sid`
                    in the URL path to address the resource.
                Actions:
                  description: >-
                    The JSON string that specifies the
              ...
              properties:
                UniqueName:
                  ...
                  description: >-
                    An application-defined string that uniquely identifies the
                    new resource. It can be used as an alternative to the `sid`
                    in the URL path to address the resource. This value must be
                    unique and 64 characters or less in length.
                FriendlyName:
                  type: string
                  description: >-
                    A descriptive string that you create to describe the new
            ...
            schema:
              ...
              properties:
                ...
                Events:
                  type: string
                  description: >-
                    The list of space-separated events that this Webhook will
                    subscribe to.
                WebhookUrl:
                  type: string
                  format: uri
