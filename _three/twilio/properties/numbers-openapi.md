...
paths:
    ...
    get:
      ...
      parameters:
        ...
        - name: OrderStatus
          in: query
          description: >-
            Order status can be used for filtering on Hosted Number Order status
            values. To see a complete list of order statuses, please check
            'https://www.twilio.com/docs/phone-numbers/hosted-numbers/hosted-numbers-api/hosted-number-order-resource#status-values'.
          schema:
            type: string
      responses:
            ...
            schema:
              ...
              properties:
                ...
                Email:
                  type: string
                  description: >-
                    The email address that will receive updates when the Bundle
                ...
                RegulationSid:
                  ...
                  pattern: '^RN[0-9a-fA-F]{32}$'
                  description: >-
                    The unique string of a regulation that is associated to the
                    Bundle resource.
                IsoCountry:
                  type: string
                  description: >-
                ...
                NumberType:
                  ...
                  description: >-
                    ...
                    Can be `local`, `mobile`, `national`, or `toll free`.
              required:
                - FriendlyName
                - Email
    ...
    get:
      ...
      parameters:
        - name: Status
          in: query
          description: >-
            The verification status of the Bundle resource. Please refer to
            [Bundle
        ...
        - name: HasValidUntilDate
          in: query
          description: >-
            Indicates that the Bundle is a valid Bundle until a specified
            expiration date.
          schema:
            type: boolean
        - name: SortBy
        ...
        - name: ValidUntilDate
          in: query
          description: >-
            Date to filter Bundles having their `valid_until_date` before or
            after the specified date. Can be `ValidUntilDate>=` or
            `ValidUntilDate<=`. Both can be used in conjunction as well. [ISO
            8601](https://en.wikipedia.org/wiki/ISO_8601) is the acceptable date
            format.
          schema:
            type: string
            format: date-time
              ...
              schema:
                ...
                properties:
                  results:
                    ...
                    items:
                      $ref: >-
                        #/components/schemas/numbers.v2.regulatory_compliance.bundle
                  meta:
                    type: object
                    properties:
                      first_page_url:
  ...
  '/v2/RegulatoryCompliance/Bundles/{BundleSid}/Copies':
    ...
    post:
      description: >-
        Creates a new copy of a Bundle. It will internally create copies of all
        the bundle items (identities and documents) of the original bundle
      tags:
        - Numbers
        - Regulations
        - Compliance
        ...
        '201':
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/numbers.v2.regulatory_compliance.bundle.bundle_copy
          description: Created
      security:
        - accountSid_authToken: []
              ...
              schema:
                ...
                properties:
                  items:
                    ...
                    items:
                      $ref: >-
                        #/components/schemas/numbers.v2.authorization_document.dependent_hosted_number_order
                  meta:
                    type: object
                    properties:
                      first_page_url:
              ...
              schema:
                ...
                properties:
                  results:
                    ...
                    items:
                      $ref: >-
                        #/components/schemas/numbers.v2.regulatory_compliance.end_user
                  meta:
                    type: object
                    properties:
                      first_page_url:
              ...
              schema:
                ...
                properties:
                  end_user_types:
                    ...
                    items:
                      $ref: >-
                        #/components/schemas/numbers.v2.regulatory_compliance.end_user_type
                  meta:
                    type: object
                    properties:
                      first_page_url:
        ...
        '201':
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/numbers.v2.regulatory_compliance.bundle.evaluation
          description: Created
      security:
        - accountSid_authToken: []
    ...
    get:
      ...
      parameters:
        ...
        - name: SmsCapability
          in: query
          description: >-
            Whether the SMS capability will be hosted on our platform. Can be
            `true` of `false`.
          schema:
            type: boolean
        - name: PhoneNumber
        ...
        '201':
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/numbers.v2.regulatory_compliance.bundle.item_assignment
          description: Created
      security:
        - accountSid_authToken: []
    ...
    get:
      ...
      parameters:
        ...
        - name: NumberType
          in: query
          description: >-
            The type of phone number that the regulatory requiremnt is
            restricting.
          schema:
            type: string
        - name: PageSize
              ...
              schema:
                ...
                properties:
                  results:
                    ...
                    items:
                      $ref: >-
                        #/components/schemas/numbers.v2.regulatory_compliance.regulation
                  meta:
                    type: object
                    properties:
                      first_page_url:
  ...
  '/v2/RegulatoryCompliance/Bundles/{BundleSid}/ReplaceItems':
    ...
    post:
      description: >-
        Replaces all bundle items in the target bundle (specified in the path)
        with all the bundle items of the source bundle (specified by the
        from_bundle_sid body param)
      tags:
        - Numbers
        - Regulations
        - Compliance
      ...
      parameters:
        - name: BundleSid
          in: path
          description: >-
            The unique string that identifies the Bundle where the item
            assignments are going to be replaced.
          schema:
            type: string
            minLength: 34
            maxLength: 34
        ...
        '201':
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/numbers.v2.regulatory_compliance.bundle.replace_items
          description: Created
      security:
        - accountSid_authToken: []
        ...
        '201':
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/numbers.v2.regulatory_compliance.supporting_document
          description: Created
      security:
        - accountSid_authToken: []
              ...
              schema:
                ...
                properties:
                  supporting_document_types:
                    ...
                    items:
                      $ref: >-
                        #/components/schemas/numbers.v2.regulatory_compliance.supporting_document_type
                  meta:
                    type: object
                    properties:
                      first_page_url:
