(function webpackUniversalModuleDefinition(root, factory) {
    ...
    ([
        ...
        (function(module, exports, __webpack_require__) {
            ...
            function enableZoomOnCanvas(newMap, show) {
                map = newMap;
                //console.log("show: " + show);
                $(show).bind("wheel", function(event) {
        ...
        (function(module, exports, __webpack_require__) {
            ...
            function initialise() {
                ...
                //var show = 'canvas';
                //MetroFlow.zoom.enableZoomOnCanvas(newMap, show);
            ...
            function setLoadMapAction(callback) {
                ...
                var subway_maps = JSON.parse(document.getElementById('subway-maps').value);
                for (var i = 0; i < subway_maps.length; i++) {
                    if (subway_maps[i] != 'none') {
                        //console.log(subway_maps[i]);     
                        document.getElementById(subway_maps[i]).addEventListener('mousemove', callback, false);
                        //document.getElementById(subway_maps[i]+'-shell').addEventListener('mousemove', callback, false);
                        //document.getElementById(subway_maps[i]+'-tags').addEventListener('mousemove', callback, false);
                        //document.getElementById(subway_maps[i]+'-properties').addEventListener('mousemove', callback, false);
                    }
                }
            }
            ...
            function loadMapClicked(event) {
                ...
                var this_id = this.id;
                //console.log(this_id);
                this_id = this_id.replace("-wrapper","");
                this_id = this_id.replace("-shell","");
                this_id = this_id.replace("-tags","");
                this_id = this_id.replace("-properties","");
                //console.log(this_id);

                var contents = document.getElementById(this_id + '-store').value;
